...
# Besides any methods needed to determine the lowest and highest cards, create a #to_s 
# method that returns a String representation of the card, e.g., "Jack of Diamonds", "4 of Clubs", etc.
