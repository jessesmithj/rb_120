...
# Yes, now product_name can be changed as well, which could cause issues 
# It would be better to leave attr_reader for product_name & quantity 
# and add a private setter method for the instance variable quantity 
...
# (calling the accessor with the instance.quantity = <new value> notation) rather than by going 
# through the update_quantity method. It means that the protections built into the update_quantity 
