...
# This is done calling the method #class with the keyword self, which references the instance of the object 
# and invokes the class it belongs to, in this case, the Car class. This is works in the string because the 
# self.class is invoked using string interpolation. 
